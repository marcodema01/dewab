...
async function main() {
  ...
  if (GEMINI_API_KEY.startsWith("REPLACE_")) {
    const errorMsg =
      "Please replace 'REPLACE_WITH_YOUR_GEMINI_API_KEY' in demo/script.js with your actual Gemini API key.";
  ...
  try {
    ...
    dewab = new Dewab({
      ...
      systemInstruction:
        "You are a helpful and witty assistant. You have access to a tool that can provide a random quote. When a user asks for a quote, use the 'get_random_quote' tool. Keep your responses conversational and natural.",
      tools: [
        {
          type: "function",
